...
namespace Headstone.AI.Controllers
{
    public class BaseController : Controller
    {
        ...
        private static string _serviceClientId = ConfigurationManager.AppSettings["Lidia.Identity.ServiceClientId"];
        private static string _serviceKey = ConfigurationManager.AppSettings["Lidia.Identity.ServiceKey"];
